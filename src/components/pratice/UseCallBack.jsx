...
const UseCallbackTest = () => {
  ...
  return (
    <>
      ...
      <ChiledComp callBack={onChiledClick} />
      <button className="mainChiled" onClick={useSetState}>
        {" "}
        setState
      </button>
      <button className="mainChiled" onClick={useTestState}>
        {" "}
        useTestState
      </button>
      {state ? (
        <div className="stateTureRender"> state - ture (rneder)</div>
      ) : null}
      {stateTest ? (
        <div className="stateTureRender"> stateTest - ture (rneder)</div>
      ) : null}
    </>
  );
};
